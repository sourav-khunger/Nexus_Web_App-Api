<?php
    ...
    //  public function updatesavetime(){
    //   $query = "UPDATE " . $this->table_notification . " SET 
    // 	get_time='" . htmlspecialchars(strip_tags($this->get_time)) . "'
    //     WHERE notification_id='" . htmlspecialchars(strip_tags($this->notification_id)) . "' AND reciever_id='" . htmlspecialchars(strip_tags($this->reciever_id)) . "'";
    //     $stmt = $this->conn->prepare($query);
    //   if ($stmt->execute()) {
    //         return true;
    //     } else {
