...
echo '
<div id="zoom_timer">5:00</div>
<div class="top-content text-center">
<h3 class="title">Received a talk request🎉</h3>
<h3 class="title">Please enter Zoom or decline within 5 minutes!</h3>
<p class="sub-title">※If you do not enter Zoom within 5 minutes, it will be canceled automatically.</p>
</div>
...
echo   '</div><div class="job-history">
   ...
   echo  '</div>
      ...
      <div class="modal-footer">
          <button class="btn on" onclick=acceptCall('.$user_profile_data['user_id'].') >Enter Zoom</button><br/>
          <button class="btn hide-user" onclick=rejectCall('.$user_profile_data['user_id'].') >Decline</button><br/>
